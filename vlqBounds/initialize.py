    ...
    def initialize_tables_cms_and_atlas(self):
        ...
        if self.VLB:
            if self.m.model() == 'Singlet':
                ...
                self.expt[9] = 'CMS'
                self.file_name[9] = '2008.09835_CMS_Fig11_lower_pp_B_bZ_bH_doublet.dat'
                self.process[9] = 'pp --> BB'
                self.energy[9] = 13
