import numpy as np
from vlqBounds.models import SingletT, SingletB
...
pt.set_VLQ_type('B')
pt.filling_couplings_and_xs_limits()
for k in np.linspace(0.0001, 1.2, 30):
    for m in np.arange(700, 2000, 2):
        params = {
            "mB": m,
            "k_B": k
        ...
        pt.B_singlet_params(**params)
        pt.check_against_xs_and_coupling_limits()
pt.df.to_csv("~/vlb_doublet.dat", sep=" ")
'''
'''
def main():
    s = Singlet()
    ...
    #pt.filling_couplings_and_xs_limits()
    pt.filling_couplings_data()
    k_range = np.linspace(0.1, 1.4, 40)
    m_range = np.arange(600, 2200, 1)
    for k in k_range:
        for m in m_range:
            params = {
                "mT": m,
...
def main():
    ...
    #pt.df.to_csv("~/vlt_doublet.dat", sep=" ")
...
def main():
    ...
    #pt.filling_channels_data()
    #pt.filling_couplings_data()
    s_range = np.linspace(0.0000000000001, 1, 30)
    m_range = np.arange(700, 2100, 1)
    for k in s_range:
        for m in m_range:
            params = {
                "mT": m,
...
def main():
    ...
    #pt.filling_channels_data()
    pt.filling_couplings_data()
    s_range = np.linspace(0.0001, 1, 30)
    ...
    for s_u_r in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_u_r_atlas_single_prod_doublet.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_l_cms_single_prod.dat", sep=" ")
...
def main():
    ...
    #pt.filling_channels_data()
    #pt.filling_couplings_data()
    s_range = np.linspace(0.0000000000001, 1, 20)
    m_range = np.arange(700, 1700, 1)
    for k in s_range:
        for m in m_range:
            params = {
                "mT": m,
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_l_cms_pair_prod.dat", sep=" ")
...
def main():
    ...
    pt.df.to_csv("~/Desktop/somefiles/vlt_TB_doublet_cms_pair_prod_doubletT.dat", sep=" ")
...
def main():
    ...
    m_range = np.arange(1000, 2000, 1) # atlas from 1000
    for k in s_range:
        for m in m_range:
            params = {
                "mB": m,
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_atlas_single_prod.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_atlas_pair_prod.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_atlas_single_prod_doublet.dat", sep=" ")
...
def main():
    ...
    #pt.filling_couplings_data()
    s_range = np.linspace(1e-3, 1, 20)
    m_range = np.arange(1000, 1800, 1) # atlas from 1000
    for k in s_range:
        for m in m_range:
            params = {
                "mB": m,
...
def main():
    ...
    #pt.filling_channels_data()
    #pt.filling_couplings_data()
    s_range = np.linspace(1e-3, 1, 25)
    m_range = np.arange(700, 2000, 1) # atlas from 1000
    for k in s_range:
        for m in m_range:
            params = {
                "mB": m,
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_cms_single_prod.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_cms_single_prod_doublet.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_cms_pair_prod.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_cms_pair_prod_doublet.dat", sep=" ")
...
def main():
    ...
    #pt.filling_channels_data()
    #pt.filling_couplings_data()
    s_range = np.linspace(0.0001, 1, 35)
    m_range = np.arange(700, 2000, 1)
    for s_u_r in s_range:
        for m in m_range:
            params = {
                "mT": m,
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_u_r_cmsAndatlas_single_prod_doublet.dat", sep=" ")
...
def main():
    ...
    pt.df.to_csv("~/Desktop/somefiles/vlt_TB_doublet_cms_and_atlas_pair_prod_doubletT.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlB_s_l_atlas_and_cms_single_prod.dat", sep=" ")
...
def main():
    ...
    pt.filling_couplings_data()
    s_range = np.linspace(1e-3, 1, 20)
    m_range = np.arange(700, 1900, 1) # atlas from 1000
    for k in s_range:
        for m in m_range:
            params = {
                "mB": m,
...
def main():
    ...
    #pt.filling_couplings_data()
    s_range = np.linspace(1e-3, 1, 20)
    m_range = np.arange(700, 1600, 1) # atlas from 1000
    for k in s_range:
        for m in m_range:
            params = {
                "mB": m,
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_l_atlas_and_cms_single_prod.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_l_atlas_cms_pair_prod_singlet.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            #pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlt_s_u_r_atlas_pair_prod_doublet.dat", sep=" ")
...
def main():
    ...
    #pt.filling_channels_data()
    pt.filling_couplings_data()
    s_range = np.linspace(0.01, 0.5, 30)
    m_range = np.arange(700, 2100, 1)
    for k in s_range:
        for m in m_range:
            params = {
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlb_w_m_single_prod.dat", sep=" ")
...
def main():
    ...
    #pt.filling_channels_data()
    pt.filling_couplings_data()
    s_range = np.linspace(1e-3, 0.3, 30)
    m_range = np.arange(700, 1920, 1)
    for k in s_range:
        for m in m_range:
            params = {
            ...
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/vlb_w_m_single_prod_doublet.dat", sep=" ")
...
def main():
    ...
    pt = PyTop(s)
    pt.filling_couplings_data()
    s_range = np.linspace(0.1, 1, 100)
    m_range = np.arange(600, 1500, 1)
    for k in s_range:
        for m in m_range:
            params = {
                "mT": m,
            ...
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
    pt.df.to_csv("~/Desktop/somefiles/s_l_beyond_branches_exclusion.dat", sep=" ")
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            pt.X_in_doublet_XT_params(**params)
            #pt.check_singlet_limit()
            #pt.check_against_xs_and_coupling_limits()
            pt.check_coupling_limit()
            pt.df.to_csv("~/Desktop/somefiles/s_r_result_vlx_single_prod.dat", sep=" ")
main()
...
def main():
    ...
    for k in s_range:
        for m in m_range:
            ...
            #pt.check_singlet_limit()
            #pt.check_against_xs_and_coupling_limits()
            pt.check_SM_TX_doublet_limit()
            pt.df.to_csv("~/Desktop/somefiles/s_r_result_vlx_pair_prod.dat", sep=" ")
main()
"""
"""
def main():
